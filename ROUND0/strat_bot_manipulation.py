        ...
        for product in state.order_depths:
            ...
            if product == "TOMATOES":
                ...
                if len(order_depth.sell_orders) != 0 and len(order_depth.buy_orders) != 0:
                    ...
                    if state.timestamp == 2900:
                        orders.append(Order(product, 4996, -26))
                        orders.append(Order(product, 5012, 26))
                        print(f"[TOMATOES] Placing SELL order at {4996} and BUY order at {5012}")

                        orders.append(Order(product, 100_000, -10))
                        print(f"[TOMATOES] Placing SELL order at {100_000}")

                        orders.append(Order(product, 4155, 10))
                        print(f"[TOMATOES] Placing BUY order at {4155}")
